...
export class OverviewComponent {
  mesured: any[] = [
    ...
    },
    {
      ...
      desc: {
        1: 'Get reliable and realistic insights into complex and cor?? indicators to drive positive transformation',
    ...
    },
    {
      ...
      desc: {
        1: 'Monitor and boost student re?? and completion rates',
